...
const networks = {
  standard: [
    ...
    { name: "Threads", color: "text-gray-900", path: "M14.096 2.034c-1.87-.082-3.382.248-4.658.975-1.251.713-2.244 1.785-2.988 3.16-.696 1.286-1.09 2.766-1.204 4.413-.092 1.328-.029 2.136.185 2.839.19.628.465 1.166.823 1.624.695.892 1.654 1.447 2.704 1.487.825.032 1.602-.204 2.197-.668.278-.217.509-.46.675-.724.435-.69.525-1.389.393-2.101-.163-.882-.68-1.566-1.475-2.088-1.144-.751-2.764-1.043-4.743-.856.101-1.06.321-2.039.658-2.9.756-1.93 2.016-3.093 3.572-3.473.908-.222 1.91-.109 2.843.09 1.102.235 2.117.649 3.003 1.221 1.267.818 2.073 1.88 2.576 3.286.386 1.083.541 2.319.541 3.752v.301c0 3.44-.684 5.894-2.32 7.482-1.487 1.444-3.728 2.094-6.619 2.03-3.017-.067-5.236-1.023-6.81-2.89-1.485-1.76-2.195-4.36-2.188-7.849.007-3.293.725-5.933 2.219-7.806C6.536 3.87 8.781 2.71 11.69 2.39c1.255-.138 2.573-.075 3.91.225.167.039.275.207.237.374a.314.314 0 01-.03.072l-.45.806a.293.293 0 01-.33.143 11.849 11.849 0 00-3.288-.463c-2.438.035-4.336.947-5.636 2.691-1.072 1.436-1.647 3.508-1.698 6.18 1.636-.273 3.156-.153 4.457.359 1.234.486 2.145 1.283 2.661 2.309.413.821.543 1.725.388 2.658-.076.454-.222.853-.437 1.196-.23.367-.52.667-.832.897-.705.52-1.523.744-2.306.702-1.241-.067-2.29-.742-3.1-1.754-.719-.9-1.12-2.13-1.167-3.68-.018-.588-.004-1.253.044-1.988.065-.991.218-1.954.455-2.875.943-3.666 3.14-5.982 6.14-6.632C12.252 2.203 13.17 2.084 14.096 2.034z" },
...
function NetworkIcon({ name, color, path }: { name: string; color?: string; path?: string }) {
  return (
    <div className="flex items-center gap-1.5 text-xs" title={name}>
      {path ? (
        <svg className={`h-3.5 w-3.5 shrink-0 ${color || "text-gray-500"}`} viewBox="0 0 24 24" fill="currentColor">
          <path d={path} />
        </svg>
      ) : (
