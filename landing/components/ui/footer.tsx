        ...
        <div className={`relative z-10 grid gap-10 py-8 sm:grid-cols-12 md:py-12 ${border ? "border-t [border-image:linear-gradient(to_right,transparent,var(--color-slate-200),transparent)1]" : ""}`}>
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-xs text-gray-400 pt-2">
              Powered by <a href="https://postiz.com" target="_blank" className="underline hover:text-gray-600">Postiz</a> (AGPLv3) — <a href="https://github.com/tu-usuario/postiz-app" target="_blank" className="underline hover:text-gray-600">Source</a>
            </div>
          </div>
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="flex gap-1">
              <li>
                <Link className="flex items-center justify-center text-blue-500 transition hover:text-blue-600" href="#0" aria-label="Twitter">
              ...
              <li>
                <Link className="flex items-center justify-center text-blue-500 transition hover:text-blue-600" href="#0" aria-label="Github">
                  <svg className="h-8 w-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
